...
class EdgePathBuilder {
    public build(args: {
        ...
        const { edges, nodePos, edgeKey, selectedEdgeKeys, activeEdgeKey } = args;
...
export function useExpressionTreeEdgePaths(args: {
    ...
    const builder = useMemo(() => new EdgePathBuilder(), []);
    ...
    }, [builder, edges, nodePos, edgeKey, selectedEdgeKeys, activeEdgeKey]);
}