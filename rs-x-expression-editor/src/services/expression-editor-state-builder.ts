...
export class ExpressionEditorStateBuilder {
  ...
  public setEditingModelIndex(modelIndex: number): this {
    const clampedEditingModelIndex =
      modelIndex >= 0 && modelIndex < this._state.modelsWithExpressions.length
        ? modelIndex
        : -1;
  ...
  public setEditingExpressionIndex(
    modelIndex: number,
    ...
    const clamped =
      ...
      editingExpressionIndex < current.expressions.length
  ...
  public selectExpression(modelIndex: number, expressionIndex: number): this {
    ...
    if (
      ...
      modelWithExpressions.selectedExpressionIndex === expressionIndex
    ) {
      return this;
    }
  ...
  public updateModel(args: {
    ...
    for (let i = 0; i < expressions.length; i++) {
      ...
      expressions[i] = {
        ...
        editorExpressionString:
          r?.expressionString ?? prev.editorExpressionString,
        changeHistory: [],
  ...
  public addExpression(args: {
    ...
    modelsWithExpressions[modelIndex] = {
      ...
      selectedExpressionIndex:
        modelsWithExpressions[modelIndex].expressions.length,
      expressions: [
        ...modelsWithExpressions[modelIndex].expressions,
        newExpressionInfo,
      ],
    };
  ...
  public setExpressionHistory(args: {
    ...
    let selectedChangeHistoryIndex =
      previousExpressionInfo.selecteChangeHistoryIndex;
