...
export class ValueMetadata implements IValueMetadata {
    ...
    constructor(
        ...
        this._valueMetadataList = [...valueMetadataList].sort((a, b) => b.priority - a.priority);
    }
    ...
    private getValueMetadata(value: unknown,): IValueMetadata {
        const valueMetadata = this._valueMetadataList.find((valueMetadata) => valueMetadata.applies(value));
