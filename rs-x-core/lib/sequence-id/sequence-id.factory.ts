...
import type {
  ISequenceIdFactory,
  ISequenceWithId,
} from './sequence-id-factory.interface';
...
> {
  ...
  constructor(
    ...
    this._valueSequenceIdRegistry = new ValueSequenceIdRegistry(
      this._guidFactory,
    );
  }
...
> {
  ...
  protected override createInstance(
    ...
    return new ValueSequenceIdsForContext(context, this._guidFactory, () =>
      this.release(id),
    );
  }

  public override releaseInstance(
    instance: ValueSequenceIdsForContext,
    _id: unknown,
  ): void {
    instance.dispose();
  }
...
export class SequenceIdFactory implements ISequenceIdFactory {
  ...
  constructor(
    ...
    this._valueSequenceIdRegistryManager = new ValueSequenceIdRegistryManager(
      guidFactory,
    );
  }
