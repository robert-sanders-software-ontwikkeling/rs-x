...
describe('FunctionCallIndexFactory tests', () => {
  ...
  it('create will return a function index', () => {
    ...
    const actual = functionCallIndexFactory.create({
      context,
      functionName: 'test',
      arguments: args,
    });
  ...
  it('Will release function index when all references have been release', () => {
    ...
    const { instance: functionIndex1 } = functionCallIndexFactory.create({
      context,
      functionName: 'test',
      arguments: args,
    });
    const { instance: functionIndex2 } = functionCallIndexFactory.create({
      context,
      functionName: 'test',
      arguments: args,
    });
  ...
  it('Will create function index per arguments id', () => {
    ...
    const actual1 = functionCallIndexFactory.create({
      context,
      functionName: 'test',
      arguments: [1],
    });
    const actual2 = functionCallIndexFactory.create({
      context,
      functionName: 'test',
      arguments: [2],
    });
