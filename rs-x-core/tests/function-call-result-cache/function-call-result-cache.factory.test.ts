...
describe('FunctionCallIndexFactory tests', () => {
  ...
  it('will release function cache result when all references have been released', () => {
    ...
    const functionCallResultCache1 = functionCallResultCacheFactory.create(
      context,
      result,
    );
    const functionCallResultCache2 = functionCallResultCacheFactory.create(
      context,
      result,
    );
    ...
    expect(
      functionCallResultCacheFactory.get(context, functionCallIndex),
    ).toBeDefined();
