...
import { LessThanExpression } from '../../../lib/expressions/less-than-expression';
import {
...
describe('LessThanExpression tests', () => {
  ...
  it('type', () => {
    ...
    expect(expression.type).toEqual(ExpressionType.LessThan);
  });
  ...
  it('clone', async () => {
    ...
    try {
      expectCompiledOrTreeInstanceOf(clonedExpression, LessThanExpression);
      expect(clonedExpression.type).toEqual(ExpressionType.LessThan);
