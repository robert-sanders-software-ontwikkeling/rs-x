...
import { BitwiseRightShiftExpression } from '../../../lib/expressions/bitwise-right-shift-expression';
import {
  ExpressionType,
  type IExpression,
...
describe('BitwiseRightShiftExpression tests', () => {
  ...
  it('clone', async () => {
    ...
    try {
      expectCompiledOrTreeInstanceOf(clonedExpression, BitwiseRightShiftExpression);
      expect(clonedExpression.type).toEqual(ExpressionType.BitwiseRightShift);
