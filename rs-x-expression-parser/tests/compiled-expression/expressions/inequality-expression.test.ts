...
import { InequalityExpression } from '../../../lib/expressions/inequality-expression';
import {
...
describe('InequalityExpression tests', () => {
  ...
  it('type', () => {
    ...
    expect(expression.type).toEqual(ExpressionType.Inequality);
  });
  ...
  it('clone', async () => {
    ...
    try {
      expectCompiledOrTreeInstanceOf(clonedExpression, InequalityExpression);
      expect(clonedExpression.type).toEqual(ExpressionType.Inequality);
