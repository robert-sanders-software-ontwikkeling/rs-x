...
describe('Core  demos', () => {
  ...
  it('deep-clone.ts', async () => {
    ...
    await expect(() => runDemo('rs-x-core/deep-clone.ts')).toOutputAsync(
      expected,
    );
  });
  ...
  it('equality-service.ts', async () => {
    ...
    await expect(() => runDemo('rs-x-core/equality-service.ts')).toOutputAsync(
      expected,
    );
  });
  ...
  it('error-log.ts', async () => {
    ...
    await expect(() => runDemo('rs-x-core/error-log.ts')).toOutputAsync(
      expected,
    );
  });
  ...
  it('redefine-custom-index-value-accessor-list.ts', async () => {
    ...
    await expect(() =>
      runDemo('rs-x-core/redefine-custom-index-value-accessor-list.ts'),
  ...
  it('wait-for-event.ts', async () => {
    ...
    await expect(() => runDemo('rs-x-core/wait-for-event.ts')).toOutputAsync(
      expected,
    );
  });
});
