        ...
        <div className='container'>
          <div className='heroGrid'>
            <div className='heroLeft'>
              ...
              <p className='hSub'>
                Declarative reactivity for runtime-bound expressions. Bind an expression to a model and rs-x tracks
                fine-grained dependencies automatically.
              </p>
            ...
            <div className='heroCardsRow'>
              <div className='heroCards' aria-label='Key sections'>
                <article className='card'>
                  <h2 className='cardTitle'>Quickstart</h2>
                  ...
                  <a className='btn btnGhost cardCta' href='#quickstart'>
                    Jump to Quickstart <span aria-hidden='true'>→</span>
                  </a>
                </article>

                <article className='card'>
                  <h2 className='cardTitle'>Documentation</h2>
                  <p className='cardText'>Learn the engine, binding, change propagation, and debugging tools.</p>
                ...
                <article className='card'>
                  ...
                  <p className='cardText'>Try expressions live and see updates as your model changes.</p>
            ...
            <header className='quickstartHeader'>
              <div className='quickstartHeaderText'>
                ...
                <p className='quickstartLead'>
                  Bind expressions to a model and rs-x builds a fine-grained dependency graph. Only identifiers read by
                  the expression become reactive.
                </p>
              </div>

              <div className='quickstartHeaderActions'>
                <Link className='btn btnPrimary' href='/get-started'>
                  Full Getting Started <span aria-hidden='true'>→</span>
                </Link>
            ...
            <div className='quickstartGrid'>
              <div className='qsSteps' aria-label='Quickstart steps'>
                <article className='qsStepCard'>
                  ...
                  <p className='qsStepText'>Your model is just normal JavaScript.</p>
                ...
                <article className='qsStepCard'>
                  ...
                  <p className='qsStepText'>When the model changes, the expression updates and emits changes.</p>
                ...
                <div className='qsNote' role='note'>
                  <strong>Key idea:</strong> model change → expression change. Minimal ceremony, predictable updates.
                </div>
              </div>
