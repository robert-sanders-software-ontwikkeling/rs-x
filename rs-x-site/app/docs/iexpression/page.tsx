    ...
    <DocsPageTemplate>
      <div className="docsApiHeader">
        <div>
          ...
          <p className="sectionLead">
            ...
            value from <span className="codeInline">value</span> and listen for
            updates through <span className="codeInline">changed</span>.
          </p>
        </div>
      ...
      <div className="docsApiGrid">
        ...
        <article className="card docsApiCard">
          ...
          <p className="cardText">
            <span className="codeInline">IExpression</span> is disposable. Call{' '}
            <span className="codeInline">dispose()</span> when you no longer
            need it.
          </p>
        </article>
