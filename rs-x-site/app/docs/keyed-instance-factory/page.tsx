...
const usageCode = dedent`
  class ArrayProxyFactory extends KeyedInstanceFactory<
    unknown[],
    IArrayProxyData,
...
export default function KeyedInstanceFactoryDocsPage() {
  return (
    <DocsPageTemplate>
        ...
        <div>
          <DocsBreadcrumbs
            items={[
              ...
              { label: '@rs-x/core' },
              { label: 'KeyedInstanceFactory' },
            ]}
          />
          <p className="docsApiEyebrow">API Reference</p>
          <h1 className="sectionTitle">KeyedInstanceFactory</h1>
          <p className="sectionLead">
            Abstract base class in{' '}
            <span className="codeInline">@rs-x/core</span> for id-based
            singleton instance reuse with built-in reference counting.
          </p>
          <p className="docsApiInterface">
            Type:{' '}
            <span className="codeInline">
              abstract class KeyedInstanceFactory&lt;...&gt;
            </span>
          </p>
        </div>
      </div>
      ...
      <div className="docsApiGrid">
        <article className="card docsApiCard">
          ...
          <p className="cardText">
            Ensures one instance per id and tracks how many owners currently use
            that instance.
          </p>
          <p className="cardText">
            When the reference count reaches zero, the instance is removed and
            teardown hooks run.
          </p>
        </article>
        ...
        <article className="card docsApiCard">
          ...
          <p className="cardText">
            <span className="codeInline">create(data)</span> increments ref
            count and returns existing or newly created instance.
          </p>
          <p className="cardText">
            <span className="codeInline">release(id)</span> decrements ref count
            and triggers cleanup when it reaches zero.
          </p>
        </article>
