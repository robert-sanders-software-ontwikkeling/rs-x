        ...
        <div className='container'>
          <div className='docsApiHeader'>
            <div>
              ...
              <h1 className='sectionTitle'>Expression Change Transaction Manager</h1>
          ...
          <div className='docsApiGrid'>
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                Queues expression changes while updates are suspended and emits
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                <span className='codeInline'>commited</span> is an observable event stream of committed root expressions.
              </p>
            </article>
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                ...
                triggers <span className='codeInline'>commit()</span>.
              </p>
              <p className='cardText'>
                <span className='codeInline'>commit()</span> flushes pending
                commit handlers.
              </p>
            </article>
