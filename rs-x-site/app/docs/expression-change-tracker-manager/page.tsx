          ...
          <div className='docsApiGrid'>
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                ...
                <span className='codeInline'>continue()</span> do not take parameters.
              </p>
            </article>
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                ...
                singleton-factory result object with <span className='codeInline'>instance</span>,
                <span className='codeInline'> id</span>, and <span className='codeInline'>referenceCount</span>.
              </p>
              <p className='cardText'>
                Tracker methods return <span className='codeInline'>void</span>;{' '}
                <span className='codeInline'>changed</span> returns observable batches of
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                Call <span className='codeInline'>dispose()</span> on the
                tracker to release manager references.
              </p>
              <p className='cardText'>
                <span className='codeInline'>pause()</span> suppresses tracking
                emissions until <span className='codeInline'>continue()</span> is called.
              </p>
            </article>
