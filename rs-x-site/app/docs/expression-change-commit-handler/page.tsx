...
export const metadata = {
  ...
  description: 'Commit callback contract used by expression transaction batching.',
};
          ...
          <div className='docsApiHeader'>
            <div>
              ...
              <p className='sectionLead'>
                Internal commit handler contract used by the transaction manager to flush pending expression
                changes in a batch.
              </p>
            </div>
            <div className='docsApiActions'>
              <Link className='btn btnGhost' href='/docs/expression-change-transaction-manager'>
          ...
          <div className='docsApiGrid'>
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                Defines how one expression node participates in a commit cycle.
                The manager gathers handlers and invokes them during flush.
              </p>
            </article>
                ...
                items={[
                  {
                    ...
                    description: 'Expression instance that owns this commit handler.',
                  },
                  {
                    name: 'root',
                    type: 'AbstractExpression',
                    description: 'Root expression being committed in the current cycle.',
                  },
                  {
                    name: 'pendingCommits',
                    type: 'Set<IExpressionChangeCommitHandler>',
                    description: 'Remaining handlers queued for the same commit cycle.',
                  },
                ]}
              />
            </article>
            ...
            <article className='card docsApiCard'>
              ...
              <p className='cardText'>
                ...
                <span className='codeInline'>boolean</span> indicating whether this handler produced a commit.
              </p>
            </article>

            <aside className='qsCodeCard docsApiCode' aria-label='IExpressionChangeCommitHandler API and usage'>
