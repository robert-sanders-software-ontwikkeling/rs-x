export const RsXStateManagerInjectionTokens = {
  ...
  IDatePropertyObserverProxyPairFactory: Symbol(
    'IDatePropertyObserverProxyPairFactory',
  ),
  ...
  IShouldWatchIndexPredicateFactory: Symbol(
    'IShouldWatchIndexPredicateFactory',
  ),
  ...
  IPropertyObserverProxyPairFactoryProviderFactory: Symbol(
    'IPropertyObserverProxyPairFactoryProviderFactory',
  ),
