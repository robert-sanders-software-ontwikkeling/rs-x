...
describe('ArrayProxy tests', () => {
  ...
  describe('All array operation still work as before', () => {
    it('push', () => {
      const length = Type.cast<number[]>(observerProxyPair.proxy).push(
        100,
        200,
      );
    ...
    it('unshift', () => {
      const newLength = Type.cast<number[]>(observerProxyPair.proxy).unshift(
        0,
        -1,
      );
    ...
    it('reverse', () => {
      const reverseArray = Type.cast<number[]>(
    ...
    it('fill', () => {
      const filledArray = Type.cast<number[]>(observerProxyPair.proxy).fill(
        -1,
        1,
        3,
      );
  ...
  describe('Change event', () => {
    ...
    it('push will trigger change event for all added elements', async () => {
      ...
      const expected: IPropertyChange[] = [
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 4 }],
          index: 4,
          newValue: 10,
        ...
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 5 }],
          index: 5,
          newValue: 11,
          target: arrayData.array,
        },
    ...
    it('splice will trigger change event for changed elements', async () => {
      ...
      const expected: IPropertyChange[] = [
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 1 }],
          index: 1,
          newValue: 10,
          target: arrayData.array,
        },
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 2 }],
          index: 2,
          newValue: 11,
          target: arrayData.array,
        },
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 3 }],
          index: 3,
          newValue: 3,
          target: arrayData.array,
        },
    ...
    it('shift will trigger change event', async () => {
      ...
      const expected: IPropertyChange[] = [
        {
          arguments: [],
          chain: [{ context: arrayData.array, index: 0 }],
          index: 0,
          newValue: 2,
          target: arrayData.array,
        },
